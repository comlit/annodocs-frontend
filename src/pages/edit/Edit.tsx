...
function Edit() {
    ...
    //fetching from backend is disabled for now
    /*
    useEffect(() => {
    ...
    */
    ...
    useEffect(() => {
        const exampleParagraphData = {number: "§ 434", title: "Sachmangel", book: "Bürgerliches Gesetzbuch (BGB)"}
        const exampleText = [
            {
                "id": 1,
        ...
        setParagraph(exampleParagraphData)
    }, []);
