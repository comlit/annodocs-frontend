...
function Dashboard() {
    ...
    return (
        <Box marginTop = "20px"  w="100vw" display="flex" alignItems="center" justifyContent="flex-end" bg={bg}>
            <Box p={8} maxW="6xl" w="full" >
                <HStack spacing = {4} alignItems="flex-start" zIndex="10" >
                
                <Stack spacing={2} zIndex = "10"  w = "70%">
                    ...
                    //eigene Annotationen
                    <Box  className="dashboard-eigene-annotationen" height = "30vh" mt={5} p={4} bg="white" boxShadow="md" borderRadius="md" textAlign="center">
                    ...
                    <Box height = "30vh" mt={5} p={4} bg="white" boxShadow="md" borderRadius="md" textAlign="center" className="dashboard-vorgeschlagene-gesetze">
                    <Heading as="h2" size="md" mb={4} >
                            Vorgeschlagene Gesetze
                        </Heading>
                ...
                //Favoriten-Box;
                <Stack spacing={2} maxW="350px" marginTop = "5px" >
                    <Box  height = "30vh" w = "full" mt={5} p={4} bg="white" boxShadow="md" borderRadius="md" textAlign="center"  className="dashboard-favoriten">
                        <Heading as="h2" size="md" mb={4}>
                                    Favoriten
                                </Heading>
                                {favorites.length > 0 ? (
                    ...
                    //Zuletzt Besucht Box;
                    <Box className = "dashboard-last-visited" h = "55vh" w = "full" mt={4} p={4} bg="white" boxShadow="md" borderRadius="md" textAlign="center" >
                        <Heading as="h2" size="md" mb={4}>
                                    Zuletzt besucht
                                </Heading>
